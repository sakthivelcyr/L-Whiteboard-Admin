...
--
-- Host: localhost
-- Generation Time: Aug 27, 2020 at 08:55 AM
...
CREATE TABLE `customer` (
  ...
  `device_latitude` varchar(200) NOT NULL,
  `device_longitude` varchar(200) NOT NULL,
...
INSERT INTO `customer` (`id`, `name`, `role`, `mobile`, `college`, `state`, `district`, `email`, `imei`, `profileUrl`, `device_latitude`, `device_longitude`, `firebaseToken`, `deviceToken`, `created_at`, `updated_at`) VALUES
(1, 'a', 'Faculty', '9629904715', 'gce', 'a', 'a', 'aklklklkkkas@gmail.com', 'jkkjkj', 'skj', '20.0909', '78.6767', '887', 'a3ea74131704be3124a9aa11', '2020-08-27 06:16:49', '2020-08-27 06:54:03');
